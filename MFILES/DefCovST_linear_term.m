...
% % defines global, high-frequency and white noise covariance functions
 ...
 cvfunc.R = @(t1,t2,dt1t2,ad,thetas) (kDP(t1,t2,thetas(4))+kMat3(dt1t2,thetas(1:2))).*(kMat1(ad,[1 thetas(3)])).*(ad<360);
...
% % defines first derivatives
 ...
 dcvfunc.R = @(t1,t2,dt1t2,ad,thetas) (kDPd(t1,t2,thetas(4))+kMat3d(t1,t2,dt1t2,thetas(1:2))).*(kMat1(ad,[1 thetas(3)])).*(ad<360);
...
% % defines sedcond derivatives
 ...
 ddcvfunc.R = @(t1,t2,dt1t2,ad,thetas) (kDPdd(t1,t2,thetas(4))+kMat3dd(dt1t2,thetas(1:2))).*(kMat1(ad,[1 thetas(3)])).*(ad<360);
...
modelspec(1).cvfunc = @(t1,t2,dt1t2,thetas,ad,fp1fp2)  cvfunc.G(dt1t2,thetas(1:2))+...
    cvfunc.R(t1,t2,dt1t2,ad,thetas(3:6)) +...
    cvfunc.M(dt1t2,ad,thetas(7:9)) +...
    cvfunc.W(dt1t2,ad,thetas(10));

modelspec(1).dcvfunc =  @(t1,t2,dt1t2,thetas,ad,fp1fp2) dcvfunc.G(t1,t2,dt1t2,thetas(1:2)) +...
    dcvfunc.R(t1,t2,dt1t2,ad,thetas(3:6)) + dcvfunc.M(t1,t2,dt1t2,ad,thetas(7:9));

modelspec(1).ddcvfunc =  @(t1,t2,dt1t2,thetas,ad,fp1fp2) ddcvfunc.G(dt1t2,thetas(1:2))...
    +ddcvfunc.R(t1,t2,dt1t2,ad,thetas(3:6)) + ddcvfunc.M(dt1t2,ad,thetas(7:9));
...
tluTGG = [
    ...
    2e4 2000 1e6 % Matern global amplitude
    ...
    .0001 .01 1e4   % Linear Regional Term
